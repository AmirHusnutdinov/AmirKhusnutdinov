...
public interface FilesController {
  ...
  ResponseEntity<String> downloadFile(@PathVariable String fileId, @PathVariable String userId)
  ...
  ResponseEntity<File> putFile(@PathVariable String fileId, @RequestBody File file)
  ...
  ResponseEntity<File> patchFile(@PathVariable String fileId, @RequestBody File file)
      throws FileNotFoundException;
}
