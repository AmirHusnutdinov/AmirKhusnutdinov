...
public class FilesControllerImpl implements FilesController {
  ...
  public ResponseEntity<String> downloadFile(@PathVariable("fileId") String fileId,
      @PathVariable("userId") String userId) throws MalformedURLException {
  ...
  public ResponseEntity<File> putFile(@PathVariable("fileId") String fileId, File newFile)
      throws FileNotFoundException {
  ...
  public ResponseEntity<File> patchFile(@PathVariable("fileId") String fileId, File newFile)
      throws FileNotFoundException {
