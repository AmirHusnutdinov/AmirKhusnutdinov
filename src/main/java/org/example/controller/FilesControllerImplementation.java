...
public class FilesControllerImplementation implements FilesController {
  ...
  public ResponseEntity<String> renameBucket(@PathVariable("newBucketName") String newBucketName,
      @PathVariable("oldBucketName") String oldBucketName) throws BucketNotFoundException {
