...
public interface FilesController {
  ...
  public ResponseEntity<String> renameFile(@PathVariable("newFileName") String newFileName,
      @PathVariable("oldFileName") String oldFileName) throws FileNotFoundException;
  ...
  public ResponseEntity<String> replaceFile(@PathVariable("newBucketName") String newBucketName,
      @PathVariable("fileName") String FileName,
      @PathVariable("oldBucketName") String oldBucketName) throws FileNotFoundException;
  ...
  public ResponseEntity<String> deleteFile(@PathVariable("fileName") String FileName)
      throws BucketNotFoundException, FileNotFoundException;
  ...
  public ResponseEntity<String> renameBucket(@PathVariable("newBucketName") String newFileName,
      @PathVariable("oldBucketName") String oldFileName)
      throws FileNotFoundException, BucketNotFoundException;
  ...
  public ResponseEntity<String> deleteBucket(@PathVariable("bucketName") String FileName)
